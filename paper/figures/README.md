...
`paper/polytechnique.sty`), which requires five image files under `pdflatex`. All five are the
real official files, supplied directly by the user:
...
| `polytechnique-armes.pdf` | large pale coat-of-arms watermark on the title page | **real** |
