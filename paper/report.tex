...
work, did not support that claim, and it was withdrawn. It is recorded here in the interest of a
complete and honest account of the project.
...
2.6 had not completed at the time of writing (Section~\ref{sec:minicpm}).}
\label{tab:backbones}
\end{table}
...
2.6 (Section~\ref{sec:minicpm}) had not completed; a video-substitution training variant was trained
