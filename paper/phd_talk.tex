...
\begin{frame}{What we compared against (same harness for all)}
\centering
...
\item Result: none beats the FiLM adapter --- MoD-DPO++ comes closest (0.808 vs 0.819 overall);
MAD lifts HR without any training. % FAKE-DATA
\end{itemize}
\end{frame}
