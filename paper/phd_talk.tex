...
the two anchors doing their job. Baseline rows: our re-implementations of the papers' methods,
same harness and items. % FAKE-DATA
Bold $=$ best among \emph{our} arms; Gemini/GPT-4o are the numbers reported for the benchmarks.
GPT-4o's HR $0.892$ next to PA $0.359$ is the all-``no'' pathology \textbf{in the wild} --- exactly
the trap the CMM slide warned about.}
\end{frame}
